    ...
    <div className="flex-1 flex flex-col pb-12">
      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 bg-[var(--card-bg)] rounded-2xl p-6 border border-[var(--card-border)] shadow-[var(--shadow-card)] flex flex-col justify-between animate-fadeInUp">
            <div>
              <h3 className="font-bold text-[var(--foreground)] text-base mb-6">
                ملخص المستخدمين
              </h3>

              <div className="flex items-center gap-3 mb-6 p-3 bg-[var(--card-hover)] rounded-xl border border-[var(--card-border)]">
                <div className="w-12 h-12 rounded-full bg-teal-100 dark:bg-teal-500/15 text-teal-700 dark:text-teal-400 flex items-center justify-center font-bold text-lg">
                  <UserCheck className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-bold text-[var(--foreground)] text-base">Admin User</h4>
